...
lazy val root = (project in file("."))
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "org.scalatra" %% "scalatra-json" % ScalatraVersion exclude ("org.slf4j", "slf4j-api"),
      "org.scalatra" %% "scalatra-scalatest" % ScalatraVersion % "test" exclude ("org.slf4j", "slf4j-api"),
      ...
      "com.google.inject" % "guice" % "5.1.0" exclude ("org.slf4j", "slf4j-api"),
      ...
      "org.jxls" % "jxls" % "2.12.0" exclude ("org.slf4j", "slf4j-api") exclude ("org.slf4j", "jcl-over-slf4j"),
