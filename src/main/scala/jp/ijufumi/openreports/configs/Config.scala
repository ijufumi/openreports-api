...
object Config {
  ...
  val REDIS_POOL_MAX_SIZE: Int = getEnvIntValue("REDIS_POOL_MAX_SIZE", 20)
  ...
  // for reports
  val SEED_TEMPLATE_ROOT_PATH: String = getEnvValue("SEED_TEMPLATE_ROOT_PATH", "resources/reports")
  val TEMPLATE_ROOT_PATH: String = getEnvValue("TEMPLATE_ROOT_PATH", "/app/templates/")
